 ...
 *     switch (chunk.type) {
 *	     case jvmpin.CHUNKTYPE.STDOUT: console.log(chunk.data); break;
 *       case jvmpin.CHUNKTYPE.STDERR: console.error(chunk.data); break;
 *       default:
 *       	console.trace(chunk.type + " - " + chunk.data);
 *     }
 *   });
 *
